...
hooks = [
    ...
    dict(
        ...
        class_names="/home/yli7/scratch/datasets/gaussian_world/preprocessed/scannetpp_v2_default_fix_xyz_gs/metadata/semantic_benchmark/top100.txt",
        text_embeddings="/home/yli7/scratch/datasets/gaussian_world/preprocessed/scannetpp_v2_default_fix_xyz_gs/metadata/semantic_benchmark/top100_text_embeddings_siglip2.pt",
...
data = dict(
    ...
    train=dict(
        ...
        split=(
            ...
            "train_grid1mm_chunk6x6_stride3x3_mcmc",
            "test_grid1mm_chunk6x6_stride3x3_mcmc",
        ),
        data_root=data_root,
