...
# misc custom setting
gpu_nums = 1
batch_size = 1 * gpu_nums  # bs: total bs in all gpus
num_worker = 12
mix_prob = 0.8
empty_cache = False
enable_amp = True
...
model = dict(
    ...
    criteria=[
        ...
        dict(type="L2Loss", reduction="mean", loss_weight=0.5),
        dict(type="AggregatedContrastiveLoss", temperature=0.2, reduction="mean", loss_weight=0.01),
    ],
)
...
data_root = (
    "/home/yli7/scratch/datasets/gaussian_world/preprocessed/scannetpp_v1_default_fix_xyz_gs"
)
...
hooks = [
    ...
    dict(type="LangPretrainZeroShotSemSegEval", 
         ...
         text_embeddings='/home/yli7/scratch/datasets/gaussian_world/preprocessed/scannetpp_v1_default_fix_xyz_gs/metadata/semantic_benchmark/top100_text_embeddings.pt',
         excluded_classes=None, ignore_index=-1, confidence_threshold=0.1),
...
data = dict(
    ...
    val=dict(
        ...
        transform=[
            ...
            dict(type="SphereCrop", point_max=192000, mode="all"),
            dict(type="CenterShift", apply_z=False),
            dict(type="NormalizeColor"),
            dict(type="ToTensor"),
            dict(
