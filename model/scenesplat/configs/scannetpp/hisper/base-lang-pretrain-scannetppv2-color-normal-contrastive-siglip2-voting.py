...
data_root = (
    "/home/yli7/scratch2/datasets/gaussian_world/preprocessed/scannetpp_v2_default_fix_xyz_gs"
)
...
hooks = [
    ...
    dict(type="LangPretrainZeroShotSemSegEval", 
         class_names='/home/yli7/scratch2/datasets/scannetpp_v2/metadata/semantic_benchmark/top100.txt',
         text_embeddings='/home/yli7/scratch2/datasets/scannetpp_v2/metadata/semantic_benchmark/top100_text_embeddings_siglip2.pt',
...
data = dict(
    ...
    train=dict(
        ...
        filtered_scene=['c601466b77', '654a4f341b', '0f25f24a4f', '72f527a47c', '2c7c10379b', '5ea3e738c3', '27dd4da69e', '281ba69af1', '816e996553'], # filtered out for lang pretraining
        transform=[
            ...
            dict(
                ...
                hash_type="fnv",
                mode="train",
                keys=("coord", "color", "normal", "segment", "lang_feat", "valid_feat_mask"), 
    ...
    test=dict(
        ...
        transform=[
            ...
            dict(type="NormalizeColor"),
            #dict(type="NormalizeCoord"),
            dict(type="Copy", keys_dict={"segment": "origin_segment", "coord": "origin_coord", "valid_feat_mask":"origin_feat_mask"}), # important! Later, once the model’s outputs are reassembled back to the original number of points
            dict(
                type="GridSample",
                grid_size=0.01, # Creates single sample per grid cell
                hash_type="fnv",
                mode="train",
                keys=("coord", "color","normal", "lang_feat", "valid_feat_mask"),
