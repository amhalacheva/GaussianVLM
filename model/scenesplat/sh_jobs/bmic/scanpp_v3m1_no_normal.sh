...
export PYTHONPATH=./
python tools/train.py --config-file configs/scannetpp/semseg-pt-v3m1-0-base-no-normal.py --options save_path=exp/scannetpp/semseg-pt-v3m1-0-base-no-normal-debug

# resume=True weight=/usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/iccv_2025/Pointcept/exp/scannetpp/semseg-pt-v3m1-0-base-no-normal/model/model_last.pth


# export PYTHONPATH=./
# python tools/test.py --config-file configs/scannetpp/semseg-pt-v3m1-0-base-no-normal.py --num-gpus 1 --options save_path=exp/scannetpp/semseg-pt-v3m1-0-base-no-normal_save weight=/usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/iccv_2025/Pointcept/exp/scannetpp/semseg-pt-v3m1-0-base-no-normal/model/model_best.pth
