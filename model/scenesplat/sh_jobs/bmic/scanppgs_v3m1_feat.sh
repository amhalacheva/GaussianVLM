...
#SBATCH --output=sbatch_log/all_gs_mcmc_%j.out
#SBATCH --nodes=1
...
cd /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/iccv_2025/GS_Transformer/
export PYTHONPATH=./
python tools/train.py --config-file configs/scannetpp/semseg-gs-v3m1-0-base-feat.py --options save_path=exp/scannetppgs_mcmc/semseg-gs-v3m1-0-base-feat-debug

# resume=True weight=/usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/iccv_2025/Pointcept/exp/scannetppgs_mcmc/semseg-gs-v3m1-0-base-all/model/model_last.pth

# export PYTHONPATH=./
# python tools/test.py --config-file configs/scannetpp/semseg-gs-v3m1-0-base-all.py --options save_path=exp/scannetppgs_mcmc/semseg-gs-v3m1-0-base-all_save weight=exp/scannetppgs_mcmc/semseg-gs-v3m1-0-base-all/model/model_best.pth
...
# python preprocess_scannetpp_gs.py --dataset_root /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/iccv_2025/Pointcept/data/scannet_full --output_root /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/iccv_2025/Pointcept/data/scannetppgs_processed_default_prune --num_workers 1 --gs_root /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/iccv_2025/Pointcept/data/scannetpp_default_3dgs --pc_root /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/iccv_2025/Pointcept/data/scannetpp



# cd /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/iccv_2025/Pointcept
# export PYTHONPATH=./
# python tools/train.py --config-file configs/scannetpp/semseg-pt-v3m1-0-base.py --options save_path=exp/scannetpp/semseg-pt-v3m1-0-base
