...
cd /usr/bmicnas02/data-biwi-01/qimaqi_data/workspace/iccv_2025/Pointcept/
export PYTHONPATH=./
python tools/train.py --config-file configs/scannetpp/semseg-gs-v3m1-0-base-all.py --options save_path=exp/scannetppgs_mcmc/semseg-gs-v3m1-0-base-all-debug
