...
#SBATCH --ntasks-per-node=1 # 1 for single gpu
...
export PYTHONPATH=./
python tools/train.py --config-file configs/scannetpp/hisper/semseg-gs-v3m1-0-base-feat.py --options save_path=exp/scannetppgs_default/semseg-gs-v3m1-0-base-feat --num-gpus 1
