...
srun python tools/train.py \
        --config-file configs/scannetpp/snellius/base-lang-pretrain-ppv2-fixed-mcmc-all-wo-normal-late-contrastive.py \
        --options save_path=exp/lang_pretrainer/base-scannetpp-v2-fixed-and-mcmc-wo-normal-contras-siglip2-voting \
        ...
        weight=/home/yli7/projects/gaussian_world/GS_Transformer/exp/lang_pretrainer/base-scannetpp-v2-fixed-and-mcmc-wo-normal-contras-siglip2-voting/model/model_best.pth
