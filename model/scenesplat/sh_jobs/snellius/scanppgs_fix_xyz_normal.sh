...
python -u tools/train.py \
        --config-file configs/scannetpp/snellius/semseg-gs-v3m1-0-base-normal-w-fix-xyz.py \
        --options save_path=exp/scannetppgs_default_fix_xyz/semseg-gs-v3m1-0-base-normal-wo-sampling-tail-classes \
