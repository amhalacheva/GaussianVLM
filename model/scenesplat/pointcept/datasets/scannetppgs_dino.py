...
class ScanNetPPGSDataset(DefaultDataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.transform_prime = Compose(transform_prime)
    ...
    def get_data(self, idx):
        ...
        if "coord_oriented_bbox" in data_dict.keys():
            data_dict["bbox_center"] = data_dict["coord_oriented_bbox"][0].astype(np.float32)
            data_dict["bbox_extent"] = data_dict["coord_oriented_bbox"][1].astype(np.float32)
            data_dict["bbox_rot"] = data_dict["coord_oriented_bbox"][2].astype(np.float32)
