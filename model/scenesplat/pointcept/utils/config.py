    ...
    def pretty_text(self):
        ...
        def _format_basic_types(k, v, use_mapping=False):
            if isinstance(v, str):
                ...
                v_str = str(v)
                if "Parameter containing:" in v_str or "Group" in v_str:
                    v_str = "'<torch_parameter_skipped>'"
        ...
        text, _ = FormatCode(text, style_config=yapf_style) # verify=True removed in new env
